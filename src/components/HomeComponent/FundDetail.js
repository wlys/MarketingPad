...
var FundDetailHeader=require('./FundDetailHeader');
var {
    StyleSheet,
    TouchableOpacity,
    Text,
...
var FundDetail = React.createClass({
    render: function() {
        return (
            <View>
                <FundDetailHeader navigator={this.props.navigator} title="基金详情" mainScreen={this.props.mainScreen} depth={this.props.router.depth}></FundDetailHeader>
